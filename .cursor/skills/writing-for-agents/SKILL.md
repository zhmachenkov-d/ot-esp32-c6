...
description: Writing documents for agents (skills, AGENTS.md, CLAUDE.md). Use when creating or editing skills, skill descriptions, progressive disclosure, context pointers, or modifying AGENTS.md or CLAUDE.md.
---
