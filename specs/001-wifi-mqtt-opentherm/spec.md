...
- **FR-010**: Matching a particular commercial gateway’s UI/layout is **not** required. Omitting boiler-supported readable or writable Data IDs from HA exposure as an optimization, size reduction, or “thin” subset is **not** allowed — entity coverage remains governed by **FR-002**.
